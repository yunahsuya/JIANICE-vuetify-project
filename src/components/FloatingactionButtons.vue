<template>
  <v-app>
      ...
      <v-row dense>
        <v-col cols="12" sm="3">
          ...
          <v-radio-group v-model="fabPosition" density="compact" hide-details>
            <v-radio label="App (fixed)" value="fixed" />
        ...
        <v-col cols="12" sm="3">
          ...
          <v-radio-group v-model="fabLocation" density="compact" :disabled="!fabPosition" hide-details>
            <div class="d-flex">
    ...
    <v-card border :class="fabPosition === 'absolute' ? 'demo-panel-relative' : 'demo-panel-static'" flat>
      <v-fab
        :key="fabPosition"
